          ...
          <div className="space-y-8 flex flex-col justify-between h-full">
            <div className="space-y-8">
              ...
              <ul className="space-y-4 text-[15px] font-medium">
                ...
                <li><Link to="/products?cat=color-body" className="hover:text-white transition-colors flex items-center group"><ArrowRight size={14} className="mr-2 opacity-0 group-hover:opacity-100 -ml-5 group-hover:ml-0 transition-all text-[#5D4037]" /> Color Body Tiles</Link></li>
