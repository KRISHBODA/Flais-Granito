                ...
                <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:gap-3">
                  {[
                    ...
                    <a
                      ...
                      className={`group flex min-w-0 sm:min-w-[125px] sm:flex-none items-center justify-center sm:justify-start gap-2 sm:gap-2.5 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-zinc-50 border border-zinc-200 text-zinc-500 hover:text-white hover:border-transparent transition-all duration-300 shadow-sm ${
                        social.label === 'Pinterest' ? 'col-span-2' : ''
                      }`}
